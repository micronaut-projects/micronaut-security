...
in environments such as the one described in the following diagram.
...
TIP: Read the https://guides.micronaut.io/micronaut-database-authentication-provider-groovy/guide/index.html[LDAP and Database authentication providers] to learn more.
