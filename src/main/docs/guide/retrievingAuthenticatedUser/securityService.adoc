...
The default supplier for `SecurityContext` uses Server Request attributes. You can replace providing an implementation of api:io.micronaut.security.context.SecurityContextSupplier[] via a https://docs.oracle.com/javase/tutorial/ext/basics/spi.html[Java SPI].
