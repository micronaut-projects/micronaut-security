...
The previous configuration, configures a link:{api}/io/micronaut/security/token/propagation/HttpHeaderTokenPropagator.html[HttpHeaderTokenPropagator] and a propagation filter, link:{api}/io/micronaut/security/token/propagation/TokenPropagationHttpClientFilter.html[TokenPropagationHttpClientFilter], which
...
Token propagation requires *Context Propagation* dependencies, as explained in https://docs.micronaut.io/latest/guide/#reactorContextPropagation[Reactor context propagation] section.
