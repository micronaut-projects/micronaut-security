...
[source, java]
----
include::{testssecurity}/security/SensitiveEndpointRuleReplacement.groovy[tag=preamble,indent=0]
include::{testssecurity}/security/SensitiveEndpointRuleReplacement.groovy[tag=continued,indent=0]
----
