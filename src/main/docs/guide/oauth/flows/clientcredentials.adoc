...
snippet::io.micronaut.security.docs.clientcredentials.MyClass[tags="constructor",indent=0]

or

snippet::io.micronaut.security.docs.clientcredentials.ClientCredentialsClientTest[tags="getBean",indent=0]
