...
snippet::io.micronaut.security.docs.bearerauth.BearerAuthTest[tags="bearerAuth",indent=0,title="Accessing a protected resource using an Authorization request header"]
