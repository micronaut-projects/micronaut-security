...
The code snippet below illustrates how to send a JWT token in the `Authorization` request header, using the `bearerAuth` method from api:http.MutableHttpRequest[] method:
...
TIP: Check out the https://guides.micronaut.io/micronaut-security-jwt/guide/index.html[Micronaut JWT Authentication guide] for a tutorial on Micronaut's JWT support.
