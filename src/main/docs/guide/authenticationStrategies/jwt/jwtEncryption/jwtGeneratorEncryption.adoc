...
snippet::io.micronaut.security.docs.jwtencryption.RSAOAEPEncryptionConfiguration[tags="clazz"]
...
snippet::io.micronaut.security.docs.jwtencryption.KeyPairProvider[tags="clazz"]
