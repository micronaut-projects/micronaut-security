...
NOTE: The use of JSR 250 annotations requires `io.micronaut.security:micronaut-security-annotations` in the annotation processor classpath (`annotationProcessor`, `kapt` or `ksp`, `compileOnly`) respectively for Java, Kotlin, Groovy.
