...
/**
 * {@link ConfigurationProperties} implementation of {@link RevocationEndpoint}.
 *
 * @since 1.0.0
 * @author Sergio del Amo
 */
@ConfigurationProperties(RevocationEndpointConfigurationProperties.PREFIX)
public class RevocationEndpointConfigurationProperties implements RevocationEndpoint {
    ...
    /**
     *
     * @param url Revocation Endpoint's url.
     */
