...
@Property(name = "micronaut.security.csp.script-src.values[1]", value = "https://cdn.jsdelivr.net")
...
class ScriptSrcSelfUrlsTest {
    ...
    void scriptSrcUrls(@Client("/") HttpClient httpClient) {
        ...
        assertEquals("'self' 'sha256-Eco45CPSfPGYCeRWuzpCqnc/toI8+r22Lkjfm5XoezE=' https://cdn.jsdelivr.net", directive.value());
    }
