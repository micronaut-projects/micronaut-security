...
@Property(name = "spec.name", value = "ScriptSrcHttpsTest")
@MicronautTest
class ScriptSrcHttpsTest {
    @Test
    void scriptHttps(@Client("/") HttpClient httpClient) {
        ...
        assertEquals("https:", directive.value());
    }

    @Requires(property = "spec.name", value = "ScriptSrcHttpsTest")
