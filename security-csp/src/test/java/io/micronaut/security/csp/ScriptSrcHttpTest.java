...
@Property(name = "micronaut.security.csp.script-src.http", value = StringUtils.TRUE)
@Property(name = "spec.name", value = "ScriptSrcHttpTest")
@MicronautTest
class ScriptSrcHttpTest {
    @Test
    void scriptHttp(@Client("/") HttpClient httpClient) {
        ...
        assertEquals("http:", directive.value());
    }

    @Requires(property = "spec.name", value = "ScriptSrcHttpTest")
