...
internal class ClientCredentialsClientTest {

    @Test
    fun clientCredentialsClientsCanBeRetrievedByName(myClass: MyClass, beanContext: ApplicationContext) {
        assertNotNull(myClass.googleClientCredentialsClient)
        //tag::getBean[]
        val client = beanContext.getBean(ClientCredentialsClient::class.java, Qualifiers.byName("companyauthserver"))
        //end::getBean[]
