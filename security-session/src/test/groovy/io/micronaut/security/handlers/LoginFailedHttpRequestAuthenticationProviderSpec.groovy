...
@Property(name = "spec.name", value="LoginFailedHttpRequestAuthenticationProviderSpec")
@MicronautTest
class LoginFailedHttpRequestAuthenticationProviderSpec extends Specification {
    ...
    @Requires(property = "spec.name", value="LoginFailedHttpRequestAuthenticationProviderSpec")
    @Singleton
