...
@Property(name = "spec.name", value="LoginFailedHttpRequestExecutorAuthenticationProviderSpec")
@MicronautTest
class LoginFailedHttpRequestExecutorAuthenticationProviderSpec extends Specification {
    ...
    @Requires(property = "spec.name", value="LoginFailedHttpRequestExecutorAuthenticationProviderSpec")
    @Singleton
    static class AuthenticationProviderMock<B> implements HttpRequestExecutorAuthenticationProvider<B> {
        @Override
        @NonNull AuthenticationResponse authenticate(@Nullable HttpRequest<B> requestContext, @NonNull AuthenticationRequest<String, String> authRequest) {
