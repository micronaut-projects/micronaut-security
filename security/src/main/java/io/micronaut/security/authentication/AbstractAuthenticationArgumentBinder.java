 ...
 *
 * @param <A> the {@link Authentication} type
 * @author Burt Beckwith
 * @since 3.2
 */
public abstract class AbstractAuthenticationArgumentBinder<A extends Authentication> implements TypedRequestArgumentBinder<A> {

    private final Class<A> authenticationClass;
    private final Argument<A> argumentType;

    protected AbstractAuthenticationArgumentBinder(Class<A> authenticationClass) {
