...
@Property(name = "spec.name", value = "HttpRequestAuthenticationProviderAuthenticationResponseFailureSpec")
@Property(name = "micronaut.http.client.follow-redirects", value = StringUtils.FALSE)
@MicronautTest
class HttpRequestAuthenticationProviderAuthenticationResponseFailureSpec extends Specification {
    ...
    @Requires(property = "spec.name", value = "HttpRequestAuthenticationProviderAuthenticationResponseFailureSpec")
    @Singleton
