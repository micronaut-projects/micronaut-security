...
class RolesSeparatorSpec extends EmbeddedServerSpecification {
    ...
    void "it is possible to specify the claim name which stores the roles and split them using a separator"() {
        given: '''A JWT which may be generated outside of Micronaut. 
...
But in real life it maybe a token generated by a thirdparty authorization server. Thus, we have no control about the claims.
    ...
    @Requires(property = 'spec.name', value = 'RolesSeparatorSpec')
    @Controller
