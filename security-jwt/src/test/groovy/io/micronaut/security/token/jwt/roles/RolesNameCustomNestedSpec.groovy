...
class RolesNameCustomNestedSpec extends EmbeddedServerSpecification {

    @Override
    String getSpecName() {
        'RolesNameCustomNestedSpec'
    }
    ...
    void "it is possible to specify a different claim name to store the roles in the JWT we generate"() {
        when:
    ...
    @Requires(property = 'spec.name', value = 'RolesNameCustomNestedSpec')
    @Controller
