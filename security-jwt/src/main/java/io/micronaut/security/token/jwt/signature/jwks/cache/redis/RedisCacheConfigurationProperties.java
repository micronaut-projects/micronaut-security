...
@ConfigurationProperties(RedisCacheConfigurationProperties.PREFIX)
public class RedisCacheConfigurationProperties {

    public static final String PREFIX = ExternalJwksCacheConfigurationProperties.PREFIX + ".redis";

    private static final Integer TTL_DEFAULT = 3600;
    private Integer ttl;
