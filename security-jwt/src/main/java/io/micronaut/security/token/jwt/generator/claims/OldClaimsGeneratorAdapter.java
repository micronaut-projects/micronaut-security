...
/**
 * Adapts from {@link io.micronaut.security.token.claims.ClaimsGenerator} to {@link ClaimsGenerator}.
 * @author Sergio del Amo
 * @since 3.2.0
 */
@Deprecated
@Internal
public class OldClaimsGeneratorAdapter implements ClaimsGenerator {

    private final io.micronaut.security.token.claims.ClaimsGenerator claimsGenerator;

    public OldClaimsGeneratorAdapter(io.micronaut.security.token.claims.ClaimsGenerator claimsGenerator) {
