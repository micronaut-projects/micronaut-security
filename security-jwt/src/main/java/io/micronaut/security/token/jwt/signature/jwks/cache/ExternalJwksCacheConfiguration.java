...
public interface ExternalJwksCacheConfiguration extends Toggleable {

    ExternalJwksCacheType getCacheType();

    DynamoDbCacheConfiguration getDynamoDbCacheConfiguration();
