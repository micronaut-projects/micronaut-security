...
@Property(name = "spec.name", value = "UserAuditingSpec")
@MicronautTest(transactional = false)
class UserAuditingSpec extends Specification {
    ...
    def "createdBy and updatedBy are populated on save"() {
        ...
        then:
        book.id
        book.creator == "sherlock"
        book.editor == "sherlock"
    }

    @Requires(property = "spec.name", value = "UserAuditingSpec")
