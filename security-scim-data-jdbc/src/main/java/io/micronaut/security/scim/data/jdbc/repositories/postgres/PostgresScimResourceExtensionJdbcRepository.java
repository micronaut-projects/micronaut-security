...
/**
 * PostgreSQL JDBC repository for custom SCIM resource extension rows.
 *
 * @since 5.4.0
 */
...
@Experimental
public interface PostgresScimResourceExtensionJdbcRepository extends ScimResourceExtensionJdbcRepository {
}
