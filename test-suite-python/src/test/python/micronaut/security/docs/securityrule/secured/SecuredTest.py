...
class SecuredTest:
    ...
    @Test
    def test_anonymous_endpoint_can_be_accessed_without_authentication(self):
        self.httpClient.toBlocking().exchange(HttpRequest.GET("/example/anonymous"))

    @Test
    def test_authenticated_endpoint_requires_an_authenticated_user(self):
    ...
    @Test
    def test_admin_endpoint_requires_one_of_the_roles(self):
        client = self.httpClient.toBlocking()
        try:
