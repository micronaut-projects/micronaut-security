...
@Property(name = FetchMetadataRulesConfiguration.PROPERTY_ALLOW_SIMPLE_NAVIGATION,
    value = StringUtils.FALSE)
@MicronautTest
class SimpleTopLevelNavigationFetchMetadataRuleDisabledTest {

    @Test
    void disablingSimpleNavigationRuleRejectsCrossSiteNavigation(@Client("/") HttpClient httpClient) {
        ...
        HttpRequest<?> request = HttpRequest.GET("/fetch-metadata")
            ...
            .header(HttpHeaders.SEC_FETCH_DEST, Destination.DOCUMENT.toString());
