...
package io.micronaut.security.oauth2.openid.endpoints.endsession.impl;
...
import io.micronaut.security.oauth2.openid.providers.Auth0OpenidConfigurationCondition;
...
@Named("auth0")
@Singleton
public class Auth0EndSessionEndpointConfiguration implements EndSessionEndpoint {
