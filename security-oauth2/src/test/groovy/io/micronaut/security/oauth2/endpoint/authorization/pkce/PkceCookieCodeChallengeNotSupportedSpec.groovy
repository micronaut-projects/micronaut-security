...
class PkceCookieCodeChallengeNotSupportedSpec extends Specification {
    void "PKCE with cookie persistence but the remote server does not support any code challenge method"() {
        ...
        EmbeddedServer oauthServer = ApplicationContext.run(EmbeddedServer, [
            "spec.name": "AuthServerPkceCookieCodeChallengeNotSupportedSpec",
        ] as Map<String, Object>)

        EmbeddedServer server = ApplicationContext.run(EmbeddedServer, [
            "spec.name": "PkceCookieCodeChallengeNotSupportedSpec",
        ...
        !oauthServer.applicationContext.getBean(AuthServerController).codeChallengeMethod
    ...
    @Requires(property = "spec.name", value="PkceCookieCodeChallengeNotSupportedSpec")
    @Controller
    ...
    @Requires(property = "spec.name", value="AuthServerPkceCookieCodeChallengeNotSupportedSpec")
    @Secured(SecurityRule.IS_ANONYMOUS)
    @Controller
