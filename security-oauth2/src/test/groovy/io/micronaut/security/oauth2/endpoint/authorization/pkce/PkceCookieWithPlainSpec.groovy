...
class PkceCookieWithPlainSpec extends Specification {
    void "test PKCE with cookie persistence and a remote server which supports only code challenge plain"() {
        ...
        EmbeddedServer oauthServer = ApplicationContext.run(EmbeddedServer, [
            "spec.name": "AuthServerPkceCookieWithPlainSpec",
        ...
        EmbeddedServer server = ApplicationContext.run(EmbeddedServer, [
            "spec.name": "PkceCookieWithPlainSpec",
        ...
        'plain' == oauthServer.applicationContext.getBean(AuthServerController).codeChallengeMethod
    ...
    @Requires(property = "spec.name", value="PkceCookieWithPlainSpec")
    @Controller
    ...
    @Requires(property = "spec.name", value="AuthServerPkceCookieWithPlainSpec")
    @Secured(SecurityRule.IS_ANONYMOUS)
    @Controller
