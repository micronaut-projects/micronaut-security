...
class PkceCookieWithS256Spec extends Specification {
    void "PKCE with cookie persistence and a remote server supporting code challenge S256"() {
        ...
        EmbeddedServer server = ApplicationContext.run(EmbeddedServer, [
            "spec.name": "PkceCookieWithS256Spec",
    ...
    @Requires(property = "spec.name", value="PkceCookieWithS256Spec")
    @Controller
    ...
    @Requires(property = "spec.name", value="AuthServerPkceCookieWithS256Spec")
    @Secured(SecurityRule.IS_ANONYMOUS)
    @Controller
